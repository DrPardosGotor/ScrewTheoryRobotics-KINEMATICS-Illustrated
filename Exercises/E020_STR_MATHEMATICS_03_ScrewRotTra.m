...
% Rigid Body Motion - screw expoenetial  - Rotation + Translation  
...
% The system T(OUVW) is translated by a vector the vector p(8,-4,12), and
% then rotated 90� on the axis OU� with respect to T(OUVW)�.
%
